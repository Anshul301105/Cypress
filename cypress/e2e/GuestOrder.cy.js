...
describe('Guest Order Flow', function () {
    ...
    it('End to End Process for Guest Orders', function () {
        ...
        objProductRepo.productPageFirstItem().invoke('attr', 'id').then((id) => {
            ...
            cy.request(`https://www.youniqueproducts.com/myk/bulk/${selectedProductId}`).then((res, a) => {
                console.log(res, a);
                ...
                cy.intercept('https://stagingbeta.youniqueproducts.com/cer/carts/us/active/calculate').as('calculateCall');
